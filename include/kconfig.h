...
#define __config_enabled(arg1_or_junk, def_val) \
  ___config_enabled(arg1_or_junk 1, def_val)
 ...
 */
#define config_opt_enabled(cfg, opt_cfg, def_val) \
  _config_opt_enabled(cfg, opt_cfg, def_val)
...
#define __CONFIG_IS_ENABLED_2(option, case1) \
  __CONFIG_IS_ENABLED_3(option, case1, ())
