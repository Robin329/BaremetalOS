 ...
 */
static inline void __memcpy_fromio(void *to, const volatile void __iomem *from,
				   size_t count)
{
 ...
 */
static inline void __memcpy_toio(volatile void __iomem *to, const void *from,
				 size_t count)
{
 ...
 */
static inline void __memset_io(volatile void __iomem *dst, int c, size_t count)
{
	u64 qc = (u8)c;
